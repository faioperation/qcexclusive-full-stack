...
router.post("/:id/send-email", (0, checkAuth_1.default)(prisma_1.ERole.Admin, prisma_1.ERole.User), lead_controller_1.LeadController.sendEmailToLead);
router.post("/bulk-send-email", (0, checkAuth_1.default)(prisma_1.ERole.Admin, prisma_1.ERole.User), lead_controller_1.LeadController.bulkSendEmailToLeads);
router.get("/outreach-status", (0, checkAuth_1.default)(prisma_1.ERole.Admin, prisma_1.ERole.User), lead_controller_1.LeadController.getOutreachQueueStatus);
